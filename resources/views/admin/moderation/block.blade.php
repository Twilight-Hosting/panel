...
<h1>
    Block User
    <small>Block a user from accessing the panel.</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('admin.index') }}">Admin</a></li>
    <li><a href="{{ route('admin.moderation') }}">Moderation</a></li>
    <li class="active">Block User</li>
</ol>
@endsection
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-info">
            ...
            <form action="{{ route('admin.moderation.block') }}" method="POST">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="reason" name="reason" rows="4" required placeholder="Enter the reason for blocking this user...">{{ old('reason') }}</textarea>
                        <p class="text-muted small">Provide a clear reason for the block.</p>
                    </div>

                    <div class="form-group">
                        <label for="expires_at">Expiration Date (Optional)</label>
                        <input type="datetime-local" class="form-control" id="expires_at" name="expires_at" value="{{ old('expires_at') }}">
                        <p class="text-muted small">Leave empty for permanent block. Otherwise, the block will automatically expire at the specified date.</p>
                    </div>
                </div>
                <div class="box-footer">
                    <button type="submit" class="btn btn-info">Block User</button>
