                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <p style="margin-bottom: 0px;">Default language needs to be changed in the files</p>
                                    <span
                                        style="margin-bottom: 10px;color:#b4a8ff;display:block"
                                    >
                                        /resources/scripts/i18n.ts (line 21)
                                    </span>
                                </div>
                                <div>
                                    <input name="app:locale" type="hidden" value="{{ old('app:locale', config('app.locale')) }}">
                                </div>
                            </div>
                        </div>
                    </div>
